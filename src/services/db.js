...
const SEED_DATA = {
    ...
    cities: [
        {
            ...
            latitude: 30.2672,
            longitude: -97.7431,
            hero_image: 'https://images.unsplash.com/photo-1531210783285-b8281f662ef1?w=1600&h=600&fit=crop',
        ...
        { city_id: 'city_portland', name: 'Portland', slug: 'portland', country: 'country_us', state_province: 'OR', latitude: 45.5152, longitude: -122.6784, hero_image: 'https://images.unsplash.com/photo-1541457523724-95f54f7a40cc?w=1600&h=600&fit=crop', description: 'Keep Portland Weird', avg_rent: 1300, listing_count: 218, member_count: 850, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_san_antonio', name: 'San Antonio', slug: 'san-antonio', country: 'country_us', state_province: 'TX', latitude: 29.4241, longitude: -98.4936, hero_image: '', description: 'The Alamo City', avg_rent: 1100, listing_count: 185, member_count: 600, is_active: true, show_in_popular: false, show_in_footer: false, faq_items: [] },
        { city_id: 'city_houston', name: 'Houston', slug: 'houston', country: 'country_us', state_province: 'TX', latitude: 29.7604, longitude: -95.3698, hero_image: '', description: 'Space City', avg_rent: 1350, listing_count: 412, member_count: 1500, is_active: false, show_in_popular: false, show_in_footer: false, faq_items: [] },
        { city_id: 'city_dallas', name: 'Dallas', slug: 'dallas', country: 'country_us', state_province: 'TX', latitude: 32.7767, longitude: -96.7970, hero_image: '', description: 'Big D', avg_rent: 1400, listing_count: 367, member_count: 1100, is_active: true, show_in_popular: false, show_in_footer: false, faq_items: [] },
        { city_id: 'city_seattle', name: 'Seattle', slug: 'seattle', country: 'country_us', state_province: 'WA', latitude: 47.6062, longitude: -122.3321, hero_image: '', description: 'Emerald City', avg_rent: 1800, listing_count: 456, member_count: 1300, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_sf', name: 'San Francisco', slug: 'san-francisco', country: 'country_us', state_province: 'CA', latitude: 37.7749, longitude: -122.4194, hero_image: '', description: 'Bay Area', avg_rent: 2500, listing_count: 892, member_count: 2200, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_la', name: 'Los Angeles', slug: 'los-angeles', country: 'country_us', state_province: 'CA', latitude: 34.0522, longitude: -118.2437, hero_image: '', description: 'City of Angels', avg_rent: 2100, listing_count: 1204, member_count: 3100, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_nola', name: 'New Orleans', slug: 'new-orleans', country: 'country_us', state_province: 'LA', latitude: 29.9511, longitude: -90.0715, hero_image: '', description: 'The Big Easy', avg_rent: 1200, listing_count: 156, member_count: 450, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_paris', name: 'Paris', slug: 'paris', country: 'country_fr', state_province: 'IDF', latitude: 48.8566, longitude: 2.3522, hero_image: '', description: 'City of Light', avg_rent: 1400, listing_count: 678, member_count: 1800, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_berlin', name: 'Berlin', slug: 'berlin', country: 'country_de', state_province: 'BE', latitude: 52.5200, longitude: 13.4050, hero_image: '', description: 'Capital of Germany', avg_rent: 1100, listing_count: 534, member_count: 1500, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_amsterdam', name: 'Amsterdam', slug: 'amsterdam', country: 'country_nl', state_province: 'NH', latitude: 52.3676, longitude: 4.9041, hero_image: '', description: 'Venice of the North', avg_rent: 1600, listing_count: 412, member_count: 1100, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_charleston', name: 'Charleston', slug: 'charleston', country: 'country_us', state_province: 'SC', latitude: 32.7765, longitude: -79.9311, hero_image: '', description: 'Holy City', avg_rent: 1500, listing_count: 98, member_count: 300, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_detroit', name: 'Detroit', slug: 'detroit', country: 'country_us', state_province: 'MI', latitude: 42.3314, longitude: -83.0458, hero_image: '', description: 'Motor City', avg_rent: 1000, listing_count: 187, member_count: 550, is_active: true, show_in_popular: true, show_in_footer: true, faq_items: [] },
        { city_id: 'city_st_louis', name: 'St. Louis', slug: 'st-louis', country: 'country_us', state_province: 'MO', latitude: 38.6270, longitude: -90.1994, hero_image: '', description: 'Gateway to the West', avg_rent: 1050, listing_count: 143, member_count: 400, is_active: true, show_in_popular: true, faq_items: [] }
    ],
    countries: [
    ...
    fb_cities: [
        { fb_city_id: 'fbcity_1', country_id: 'fbc_1', city_name: 'Austin', city_image: 'https://images.unsplash.com/photo-1531218150217-54595bc2b934?w=600&h=400&fit=crop', fb_group_name: 'Austin Roommates & Rooms for Rent', fb_group_link: 'https://www.facebook.com/groups/austinroommates', total_members: 24800, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_2', country_id: 'fbc_1', city_name: 'New York City', city_image: 'https://images.unsplash.com/photo-1538970272646-f61fabb3a8a2?w=600&h=400&fit=crop', fb_group_name: 'NYC Rooms & Roommates', fb_group_link: 'https://www.facebook.com/groups/nycroommates', total_members: 142000, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_3', country_id: 'fbc_1', city_name: 'Los Angeles', city_image: 'https://images.unsplash.com/photo-1580655653885-65763b2597d0?w=600&h=400&fit=crop', fb_group_name: 'Los Angeles Roommates', fb_group_link: 'https://www.facebook.com/groups/laroommates', total_members: 89500, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_4', country_id: 'fbc_1', city_name: 'Seattle', city_image: 'https://images.unsplash.com/photo-1468824357306-a439d58ccb1c?w=600&h=400&fit=crop', fb_group_name: 'Seattle Roommates & Housing', fb_group_link: 'https://www.facebook.com/groups/seattleroommates', total_members: 31200, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_5', country_id: 'fbc_1', city_name: 'Chicago', city_image: 'https://images.unsplash.com/photo-1564767655658-4e3567c571b2?w=600&h=400&fit=crop', fb_group_name: 'Chicago Roommates & Apartments', fb_group_link: 'https://www.facebook.com/groups/chicagoroommates', total_members: 67300, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_6', country_id: 'fbc_2', city_name: 'London', city_image: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?w=600&h=400&fit=crop', fb_group_name: 'London Flatmates & Room to Rent', fb_group_link: 'https://www.facebook.com/groups/londonflatmates', total_members: 215000, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_7', country_id: 'fbc_2', city_name: 'Manchester', city_image: 'https://images.unsplash.com/photo-1543872084-c7bd3822856f?w=600&h=400&fit=crop', fb_group_name: 'Manchester Rooms & Flatmates', fb_group_link: 'https://www.facebook.com/groups/manchesterrooms', total_members: 38400, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_8', country_id: 'fbc_3', city_name: 'Berlin', city_image: 'https://images.unsplash.com/photo-1528728329032-2972f65dfb3f?w=600&h=400&fit=crop', fb_group_name: 'Berlin Rooms & WG Zimmer', fb_group_link: 'https://www.facebook.com/groups/berlinrooms', total_members: 92100, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_9', country_id: 'fbc_3', city_name: 'Munich', city_image: 'https://images.unsplash.com/photo-1595867818082-083862f3d630?w=600&h=400&fit=crop', fb_group_name: 'Munich Apartments & WG', fb_group_link: 'https://www.facebook.com/groups/munichrooms', total_members: 44600, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_10', country_id: 'fbc_4', city_name: 'Paris', city_image: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&h=400&fit=crop', fb_group_name: 'Paris Colocation & Rooms', fb_group_link: 'https://www.facebook.com/groups/pariscolocation', total_members: 78900, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_11', country_id: 'fbc_5', city_name: 'Sydney', city_image: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=600&h=400&fit=crop', fb_group_name: 'Sydney Flatmates & Share Houses', fb_group_link: 'https://www.facebook.com/groups/sydneyflatmates', total_members: 56200, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_12', country_id: 'fbc_5', city_name: 'Melbourne', city_image: 'https://images.unsplash.com/photo-1545044846-351ba102b6d5?w=600&h=400&fit=crop', fb_group_name: 'Melbourne Rooms & Flatmates', fb_group_link: 'https://www.facebook.com/groups/melbournerooms', total_members: 48300, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_13', country_id: 'fbc_6', city_name: 'Toronto', city_image: 'https://images.unsplash.com/photo-1517090504586-fde19ea6066f?w=600&h=400&fit=crop', fb_group_name: 'Toronto Roommates & Rooms', fb_group_link: 'https://www.facebook.com/groups/torontoroommates', total_members: 63800, created_at: '2026-01-01T00:00:00Z' },
        { fb_city_id: 'fbcity_14', country_id: 'fbc_6', city_name: 'Vancouver', city_image: 'https://images.unsplash.com/photo-1560814304-4f05b62af116?w=600&h=400&fit=crop', fb_group_name: 'Vancouver Roommates & Rentals', fb_group_link: 'https://www.facebook.com/groups/vancouverroommates', total_members: 41700, created_at: '2026-01-01T00:00:00Z' },
    ],
...
export function initDB() {
    ...
    if (hasLocalData) {
        ...
        // Migrate: backfill show_in_popular on cities that predate this field
        if (raw.cities && raw.cities.length > 0 && raw.cities[0].show_in_popular === undefined) {
            const defaultPopular = new Set(['city_austin', 'city_portland', 'city_seattle', 'city_sf', 'city_la', 'city_nola', 'city_paris', 'city_berlin', 'city_amsterdam', 'city_charleston', 'city_detroit', 'city_st_louis']);
            raw.cities = raw.cities.map(c => ({ ...c, show_in_popular: defaultPopular.has(c.city_id) }));
            updated = true;
        }
        // Migrate: backfill show_in_footer on cities that predate this field
        if (raw.cities && raw.cities.some(c => c.show_in_footer === undefined)) {
            raw.cities = raw.cities.map(c => ({
                ...c,
                show_in_footer: c.show_in_footer !== undefined ? c.show_in_footer : (c.show_in_popular !== false),
            }));
            updated = true;
        }
