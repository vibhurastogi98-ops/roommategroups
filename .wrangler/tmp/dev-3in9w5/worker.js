...
app.get("/r2-check", async (c) => {
  try {
    ...
    return c.json({
      success: true,
      message: "R2 Bucket is connected and working! \u{1F680}",
...
// .wrangler/tmp/bundle-TDjOiz/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-TDjOiz/middleware-loader.entry.ts
