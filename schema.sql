-- ============================================================
-- RoommateGroups D1 Database Schema
-- Full schema matching all collections in db.js
-- ============================================================
...
CREATE TABLE IF NOT EXISTS listings (
  ...
  longitude        REAL,
  rent             REAL,
  rent_type        TEXT,           -- 'monthly', 'weekly'
  room_type        TEXT,           -- 'private', 'shared'
  bathrooms        INTEGER,
  available_from   TEXT,
  lease_term       TEXT,
  amenities        TEXT,           -- JSON array of amenity_ids
...
-- ── 14. fb_countries ────────────────────────────────────────
CREATE TABLE IF NOT EXISTS fb_countries (
...
-- ── 15. fb_cities ───────────────────────────────────────────
CREATE TABLE IF NOT EXISTS fb_cities (
...
-- ── 16. user_queries (search analytics) ─────────────────────
...
-- Countries
INSERT OR IGNORE INTO countries (country_id, name, slug, code, flag_emoji, is_active) VALUES
...
-- Amenities
INSERT OR IGNORE INTO amenities (amenity_id, name, icon) VALUES
...
-- Tags
INSERT OR IGNORE INTO tags (tag_id, name, icon) VALUES
...
-- Blog Categories
INSERT OR IGNORE INTO categories (category_id, name, slug, description, color) VALUES
...
-- Cities
INSERT OR IGNORE INTO cities (city_id, name, slug, country, state_province, latitude, longitude, hero_image, avg_rent, listing_count, member_count, is_active, show_in_popular, show_in_footer) VALUES
...
-- Admin user
INSERT OR IGNORE INTO users (user_id, email, display_name, bio, city, verification_level, subscription_tier, role, is_active, created_at) VALUES
...
-- FB Cities
INSERT OR IGNORE INTO fb_cities (fb_city_id, country_id, city_name, city_image, fb_group_name, fb_group_link, total_members, is_popular, priority, created_at) VALUES
